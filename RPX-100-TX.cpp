...
int main(int argc, char *argv[])
{
    if (argc == 1)
    {
        cout << "Starting RPX-100-TX with default settings:\n";
        cout << "Mode: TX6m" << endl;
        cout << endl;
    ...
    else if (argc >= 2)
    {
        for (int c = 0; c < argc; c++)
        {
            ...
            case 1:
                ...
                if (mode == "RX")
                {
                    cout << "Starting RPX-100-TX with following setting:\n";
                ...
                {
                    cout << "Options for starting RPX-100-TX: RF-test \033[36mMODE\033[0m" << endl;
                    cout << endl;
